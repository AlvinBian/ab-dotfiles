...
const FALLBACK_COMMANDS = [
  ...
  'quality-gate', 'verify',
  'context-budget', 'prompt-optimize',
  'plan', 'aside', 'multi-plan',
  'changelog', 'adr', 'runbook',
...
const FALLBACK_AGENTS = [
  ...
  'database-reviewer', 'typescript-reviewer', 'load-tester',
  'dependency-auditor', 'accessibility',
  'build-error-resolver', 'tdd-guide',
  'data-analyst',
]
...
const FALLBACK_RULES = [
  ...
  'api-conventions', 'context-management',
  'error-handling', 'security-baseline',
  'observability', 'typescript-conventions', 'database-conventions',
]
