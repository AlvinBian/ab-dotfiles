...
import { gh, ghSync, fetchFileContent, fetchRepoBundle, fetchFilesBatch, scanDir, classifyRepoFiles } from '../external/github.mjs'
...
/**
 * 多策略技能偵測（基於 stacks/*/detect.json registry）
 *
